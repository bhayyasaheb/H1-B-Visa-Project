...
public class Q1A_DataEngineerJob {

	/*
	 * Mapper code Input key is line offset number and value is whole row
	 */
	public static class DataEngineerMapper extends Mapper<LongWritable, Text, Text, IntWritable>
	{
		Text myKey = new Text();
		...
		protected void map(LongWritable key, Text value, Context context)throws IOException, InterruptedException 
		{
			...
			if(job_title.contains("DATA ENGINEER") && job_title != null)
			{
				...
				// passing Mapper output key as DATA ENGINEER + year and value as 1
	 ...
	 *  Reducer code
	 */
	public static class DataEngineerReducer extends Reducer<Text, IntWritable, Text, DoubleWritable>
	{
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(Q1A_DataEngineerJob.class);
