...
public class Q10_JobPositionsNoPetitionsSuccessRateAbove70Percent {
	...
	{		
		...
		protected void reduce(Text key, Iterable<Text> values, Context context)throws IOException, InterruptedException 
		{
			...
			if(success_rate > 70 && totalApp >= 1000)
			{
				...
				String myValue = job_title+"\t"+String.format("%d", totalApp);
	...
	public static class SortMapper extends Mapper<LongWritable, Text, DoubleWritable, Text>
	{
		...
		protected void map(LongWritable key, Text value,Context context)throws IOException, InterruptedException 
		{
			...
			String job_title = token[1];
			String totalApp = token[2];
			
			String myVal = job_title+"\t"+totalApp;
	...
	public static void main(String[] args) throws Exception {
		...
		Job job = Job.getInstance(conf,"job positions along with the number of petitions who have the success rate more than 70%  in petitions.");
		
		job.setJarByClass(Q10_JobPositionsNoPetitionsSuccessRateAbove70Percent.class);
		...
		Job job2 = Job.getInstance(conf, "job positions  along with the number of petitions who have the success rate more than 70%  in petitions.");
		
		job2.setJarByClass(Q10_JobPositionsNoPetitionsSuccessRateAbove70Percent.class);
