...
public class Q8B_AvgPrWageForEachJobForEachYearPartTime {
	...
	public static class AvgPreWageMapper extends Mapper<LongWritable, Text, Text, Text>
	{
		...
		protected void map(LongWritable key, Text value, Context context)throws IOException, InterruptedException 
		{
			...
			if(full_time_position.equals("N"))
			{
...
public static void main(String[] args) throws Exception {
		...
		job1.setJarByClass(Q8B_AvgPrWageForEachJobForEachYearPartTime.class);
		...
		Job job2 = Job.getInstance(conf, "Average Prevailing Wage for each Job for each Year Part Time");
		
		job2.setJarByClass(Q8B_AvgPrWageForEachJobForEachYearPartTime.class);
