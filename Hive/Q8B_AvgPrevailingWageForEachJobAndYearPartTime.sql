...
--CREATE TABLE avgprewagepart2011 (year string, case_status string, job_title string, full_time_position string,avgprewage bigint)
...
--CREATE TABLE avgprewagepart2012 (year string, case_status string, job_title string, full_time_position string,avgprewage bigint)
--ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t';
...
--CREATE TABLE avgprewagepart2013 (year string, case_status string, job_title string, full_time_position string,avgprewage bigint)
--ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t';
...
--CREATE TABLE avgprewagepart2014 (year string, case_status string, job_title string, full_time_position string,avgprewage bigint)
--ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t';
...
--CREATE TABLE avgprewagepart2015 (year string, case_status string, job_title string, full_time_position string,avgprewage bigint)
--ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t';
...
--CREATE TABLE avgprewagepart2016 (year string, case_status string, job_title string, full_time_position string,avgprewage bigint)
--ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t';
