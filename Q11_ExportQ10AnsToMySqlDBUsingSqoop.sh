...
sqoop export --connect jdbc:mysql://localhost/h1b --username root --password 'password' --table h1b_final --update-mode  allowinsert --export-dir /H1BVisaProject/Pig/Q10_JobPositionsWithNoPetititionsHavingSuccessRateAbove70Percent/part-r-00000 --input-fields-terminated-by '\t' -m 1 ;
