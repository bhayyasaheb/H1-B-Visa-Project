...
--Q 1 b) Find top 5 job titles who are having highest avg growth in applications.[ALL] Using Pig MapReduce Mode
...
jobtitle = FOREACH h1b GENERATE year,job_title,case_status;

--DESCRIBE jobtitle;
--jobtitle: {year: chararray,job_title: chararray,case_status: chararray}

---------------------------------------------------------------------------------------------------------------------------------------------------


year1 = FILTER jobtitle BY year MATCHES '2011';

--DESCRIBE year1;
--year1: {year: chararray,job_title: chararray,case_status: chararray}


group1 = GROUP year1 BY job_title;

--DESCRIBE group1;
--group1: {group: chararray,year1: {(year: chararray,job_title: chararray,case_status: chararray)}}


count1 = FOREACH group1 GENERATE group AS job_title,COUNT(year1) AS count2011;

--DESCRIBE count1;
--count1: {job_title: chararray,count2011: long}

--DUMP count1;
--(VST ASSOC CLINICAL RESEARCH INFO OFCR & DIR FOR BI,3)
--(WARRANTY & PRODUCT IMPROVEMENT ENGINEERING MANAGER,2)
--(WARRANTY & PRODUCTION IMPROVEMENT ENGINEERING MANA,2)
...
joined = JOIN count1 BY job_title, count2 BY job_title,count3 BY job_title, count4 BY job_title, count5 BY job_title, count6 BY job_title;
...
avggrowth= FOREACH growth GENERATE job_title, (FLOAT)($1+$2+$3+$4+$5)/5 AS averagegrowth;
...
STORE top5jobtitle INTO '/H1BVisaProject/Pig/Q1B_Top5JobTitleHavingHighestAvgGrowth' USING PigStorage();
